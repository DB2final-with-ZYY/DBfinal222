...
@WebServlet("/insertExamGrade")
public class InsertExamGradeServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        System.out.println("(insertExam)grade:" + grade);
