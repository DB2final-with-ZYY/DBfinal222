...
@WebServlet("/updateExamGrade")
public class UpdateExamGradeServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        System.out.println("(updateExam)grade:" + grade);
        ...
        try {
            ...
            int count = gradeMapper.updateExamScore(gradeObject);
