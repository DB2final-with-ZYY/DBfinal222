...
public class ClassScheduleSearchServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            List<CourseSearchDTO> results = scheduleMapper.searchClassSchedules(
                scheduleId, semester, courseId, courseName, teacherId, teacherName, status
            );
